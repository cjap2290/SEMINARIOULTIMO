...
?>
		...
		<div id="cabecera">
				...
				<h2><?php echo $rsencabezado["subtitulo"]?></h2>
					...
					<div id="buscador">
						<input type="text" size="40"style="border-radius:6px;"/>
						<input type="button" value="Buscar Noticia" style="border-radius:6px;"/>
					</div>
...
<a href="#" title="noticias4"><img src="data2/tooltips/noticias4.jpg" alt="noticias4"/>4</a>
	...
	<script type="text/javascript" src="engine2/script.js"></script>
				...
				<div id="content">
								...
								<div class="container">
								<?php while($rsnoticia=mysql_fetch_array($noticia)){?>
								<div class="post">
										<div class="postheader">
												<div class="date shadow">
												
												<span class="day"><?php echo $rsnoticia["dia"]?></span>
												<span class="month"><?php echo $rsnoticia["mes"]?></span>
										...
										<div class="postcontent"><h2><a href="#"><?php echo $rsnoticia["titulo"]?></a></h2>

										  <p><?php echo $rsnoticia["descripcion"]?>	</p>
										  
										<?php echo '<iframe width="410" height="305" src="'.$rsnoticia['embed'].'" frameborder="0" allowfullscreen></iframe>'?>
