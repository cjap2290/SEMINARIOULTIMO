...
<a href="javascript:cargarventana('nuevomenu.php')" class="c"> Nuevo Menu </a><br><br>
...
<caption class="foninput2">MENU</caption>
...
<td align="left"><img src="principal.gif" border="0"><a href="javascript:cargarventana('modificar.php?Modee=<?php echo $row['id'] ?>')" class="c"> <?php echo $row["menu1"] ?></a></td>
<?php } else { ?>
<td align="left"><img src="index.gif" border="0"><a href="javascript:cargarventana('modificar.php?Modee=<?php echo $row['id'] ?>')" class="c"> <?php echo $row["menu1"] ?></a></td>
<?php }?>
<td align="center"> &nbsp;</td>
<?php if ($row["mostrar"]=="1") { ?>
<td align="center">Si</td>
<td width="14%" align="center"><a href="principalmenu.php?Modee=<?php echo $row["id"] ?>" class="c"> principal </a> </td>
