...
<form name="form1" action="insertarcontenido.php" method="post" onSubmit="return validar();">
...
<tr class="cuerpo1">
<td>&nbsp;</td>
<td class="cuerponoticia">&nbsp;&nbsp;Subtitulo:</td>
<td colspan="3"><input name="t2" type="text" id="t1" size="80"></td>
</tr>
<tr class="cuerpo1">
<td>&nbsp;</td>
<td valign="top" class="cuerponoticia">&nbsp;&nbsp;Descripci&oacute;n:</td>
<td colspan="3"><textarea name="t3" cols="90" rows="12" id="t3"></textarea></td>
</tr>
<tr class="cuerpo1">
<td>&nbsp;</td>
