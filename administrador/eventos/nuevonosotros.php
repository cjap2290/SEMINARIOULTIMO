...
<form name="form1" action="insertanosotros.php" method="post" onSubmit="return validar();">
...
<tr class="cuerpo1">
<td>&nbsp;</td>
<td class="cuerponoticia">&nbsp;&nbsp;Vision:</td>
<td colspan="3"><input name="t1" type="text" id="t1" size="80"></td>
</tr>
<tr class="cuerpo1">
<td>&nbsp;</td>
<td class="cuerponoticia">&nbsp;&nbsp;Imagen1:</td>
<td colspan="3"><input type="file" name="t2"size="80"></td>
</tr>

<tr class="cuerpo1">
<td>&nbsp;</td>
<td class="cuerponoticia">&nbsp;&nbsp;Mision:</td>
<td colspan="3"><input name="t3" type="text" id="t1" size="80"></td>
</tr>
<tr class="cuerpo1">
<td>&nbsp;</td>
<td class="cuerponoticia">&nbsp;&nbsp;Imagen2:</td>
<td colspan="3"><input type="file" name="t4"size="80"></td></td>
</tr>
