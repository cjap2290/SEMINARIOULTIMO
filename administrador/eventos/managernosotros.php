...
//Para la cabecera
$sql="select * from nosotros order by id desc";
...
<a href="javascript:cargarventana('nuevonosotros.php')" class="c"> Nuevo</a><br><br>
...
<caption class="foninput2">Nosotros</caption>
...
<td align="left"><img src="principal.gif" border="0"><a href="javascript:cargarventana('modificar.php?Modee=<?php echo $row['id'] ?>')" class="c"> <?php echo $row["vision"] ?></a></td>
<?php } else { ?>
<td align="left"><img src="index.gif" border="0"><a href="javascript:cargarventana('modificar.php?Modee=<?php echo $row['id'] ?>')" class="c"> <?php echo $row["vision"] ?></a></td>
<?php }?>
<td align="center"> &nbsp;</td>
<?php if ($row["mostrar"]=="1") { ?>
<td align="center">Si</td>
<td width="14%" align="center"><a href="principalnosotros.php?Modee=<?php echo $row["id"] ?>" class="c"> principal </a> </td>
